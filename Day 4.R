...
Sys.setenv(RETICULATE_PYTHON = "C:\\Users\\Dominic\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Python 3.9")
# 5. Check python path
...
robyn_directory <-"TBD"
robyn_directory <- "C:\\Users\\Dominic\\Documents"
...
print(OutputCollect)
select_model <- "3_422_2" # Pick one of the models from OutputCollect to proceed
...
AllocatorCollect2 <- robyn_allocator(
  ...
  OutputCollect = OutputCollect,
  select_model = select_model,
  date_range = "last_20", # Last 10 periods, same as c("2018-10-22", "2018-12-31")
...
json_file = "C:/Users/Dominic/Documents/Robyn_202312161531_init/RobynModel-3_422_2.json"
AllocatorCollect4 <- robyn_allocator(
  ...
  scenario = "target_efficiency",
  target_value = 2, # Customize target ROAS or CPA value
  plot_folder = "C:/Users/Dominic/Documents",
...
select_media <- "facebook_newsfeed_spend"
...
Response <- robyn_response(
  ...
  OutputCollect = OutputCollect,
  select_model = select_model,
  metric_name = "facebook_newsfeed_spend"
)
Response$plot
